          ...
          {[
            ...
            <button key={v} type="button"
              ...
              className={`flex-1 py-2.5 rounded-xl text-sm font-bold border transition-all ${
                operation === v
                  ? 'bg-terra/20 border-terra text-terra-light shadow-[0_0_12px_rgba(201,179,126,0.20)]'
          ...
          {TIPOS.map(({ value, label, icon }) => (
            <button key={value} type="button"
              ...
              className={`flex flex-col items-center gap-1.5 py-3 px-2 rounded-xl border text-center transition-all ${
                type === value
                  ? 'bg-terra/15 border-terra text-terra-light shadow-[0_0_14px_rgba(201,179,126,0.18)]'
