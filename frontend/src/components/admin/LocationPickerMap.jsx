      ...
      <form onSubmit={search} className="flex gap-2 relative">
        <div className="flex-1 relative">
          ...
          <input
            ...
            className="w-full pl-9 pr-3.5 py-2.5 bg-bark-700 border border-white/8 rounded-xl text-sm text-sand placeholder-sand-muted/35 focus:outline-none focus:border-terra/60 focus:shadow-[0_0_0_3px_rgba(196,98,45,0.10)] transition-all"
          />
        </div>
