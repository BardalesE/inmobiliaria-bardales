  ...
  return (
    ...
    >
      <svg width="32" height="32" viewBox="0 0 24 24" fill="none"
        stroke="rgba(201,164,78,0.25)" strokeWidth="1.2" strokeLinecap="round">
                  ...
                  <>
                    ...
                    >
                      <div className="w-14 h-14 rounded-full flex items-center justify-center"
                        style={{
                          background: 'rgba(201,164,78,0.88)',
                          boxShadow: '0 4px 20px rgba(201,164,78,0.45)',
          ...
          {media.map((_, i) => (
            <button key={i} type="button"
              ...
              style={{
                ...
                height: 5,
                borderRadius: 99,
                background: i === idx ? '#D9BC7A' : 'rgba(255,255,255,0.38)',
                border: 'none',
                padding: 0,
                cursor: 'pointer',
