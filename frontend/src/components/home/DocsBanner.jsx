      ...
      <div className="max-w-5xl mx-auto">
        ...
        >
          ...
          <div
            ...
            style={{ background: 'radial-gradient(ellipse 70% 80% at 10% 50%, rgba(196,98,45,0.13) 0%, transparent 65%)' }}
          />
          ...
          <div
            ...
            style={{
              background: 'linear-gradient(135deg, rgba(196,98,45,0.18) 0%, rgba(196,98,45,0.08) 100%)',
              border: '1px solid rgba(196,98,45,0.32)',
              boxShadow: '0 8px 28px rgba(196,98,45,0.18), inset 0 1px 0 rgba(255,255,255,0.06)',
            }}
          >
            <svg width="28" height="28" viewBox="0 0 24 24" fill="none" stroke="#E07840" strokeWidth="1.6" strokeLinecap="round" strokeLinejoin="round">
          ...
          <div className="relative flex-1 text-center sm:text-left">
            <div className="text-[10px] font-bold tracking-[0.22em] uppercase mb-3" style={{ color: 'rgba(224,120,64,0.65)' }}>
              Transparencia total
            </div>
            ...
            <Link
              ...
              style={{
                background: 'linear-gradient(135deg, #C4622D, #E07840)',
                boxShadow: '0 6px 24px rgba(196,98,45,0.32)',
              }}
              onMouseEnter={e => {
                e.currentTarget.style.transform = 'translateY(-2px)'
                e.currentTarget.style.boxShadow = '0 10px 32px rgba(196,98,45,0.48)'
              }}
              onMouseLeave={e => {
                e.currentTarget.style.transform = 'translateY(0)'
                e.currentTarget.style.boxShadow = '0 6px 24px rgba(196,98,45,0.32)'
              }}
            >
          ...
          <div className="absolute bottom-0 right-0 w-40 h-40 pointer-events-none opacity-[0.04]"
            style={{ background: 'radial-gradient(circle at 100% 100%, #E07840 0%, transparent 70%)' }} />
        </div>
      </div>
    </section>
  )
