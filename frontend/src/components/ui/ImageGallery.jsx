        ...
        <div className="absolute top-4 right-4 flex items-center gap-2 z-10">
          {slide.type === 'video' && (
            <div className="flex items-center gap-1.5 px-2.5 py-1 rounded-full"
              style={{ background: 'rgba(196,98,45,0.80)', backdropFilter: 'blur(8px)' }}>
          ...
          <>
            {[[-1, prev, 'left-4', 'M15 18l-6-6 6-6'], [1, next, 'right-4', 'M9 18l6-6-6-6']].map(([, fn, pos, d]) => (
              <button
                ...
                onMouseEnter={e => { e.currentTarget.style.background = 'rgba(196,98,45,0.75)' }}
            ...
            {slides.map((_, i) => (
              <button key={i} onClick={() => goTo(i)}
                style={{
                  ...
                  height: 6,
                  borderRadius: 99,
                  background: i === current ? '#E07840' : 'rgba(255,255,255,0.35)',
                  border: 'none',
                  padding: 0,
                  cursor: 'pointer',
            ...
            return (
              <button
                ...
                style={{
                  ...
                  height: 68,
                  borderRadius: 10,
                  border: active ? '2px solid #E07840' : '2px solid rgba(255,255,255,0.07)',
