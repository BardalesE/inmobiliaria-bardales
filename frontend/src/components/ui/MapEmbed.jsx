  ...
  return (
    <div>
      ...
      <div className="relative overflow-hidden" style={{ height: 280, borderRadius: '16px 16px 0 0' }}>
        ...
        >
          <div
            ...
            style={{ background: 'rgba(196,98,45,0.18)', border: '1px solid rgba(196,98,45,0.35)' }}
          >
            <svg width="9" height="9" viewBox="0 0 24 24" fill="none" stroke="#E07840" strokeWidth="2.5">
              <path d="M21 10c0 7-9 13-9 13s-9-6-9-13a9 9 0 0118 0z"/>
              <circle cx="12" cy="10" r="3"/>
            </svg>
          </div>
          <div>
            <p className="text-[9px] font-bold uppercase tracking-[0.1em]" style={{ color: '#E07840' }}>Ubicación exacta</p>
      ...
      <a
        ...
        onMouseEnter={e => {
          e.currentTarget.style.background = 'rgba(196,98,45,0.09)'
