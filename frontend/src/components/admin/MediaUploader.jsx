...
function Spinner() {
  return (
    <svg className="animate-spin" width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="#D9BC7A" strokeWidth="2.5">
      ...
      >
        <div className="flex flex-col items-center gap-3 select-none">
          <div className="w-12 h-12 rounded-xl flex items-center justify-center"
            ...
            <IconVideo color={dropActive ? '#D9BC7A' : '#9A8268'} />
          </div>
    ...
    <div className="rounded-2xl border border-white/8 bg-bark-700 p-4 space-y-3">
      ...
      <div className="h-1.5 rounded-full overflow-hidden" style={{ background: 'rgba(255,255,255,0.07)' }}>
        <div className="h-full rounded-full transition-all duration-300"
          style={{ width: `${progress}%`, background: 'linear-gradient(90deg, #C9A44E, #D9BC7A)' }} />
      </div>
