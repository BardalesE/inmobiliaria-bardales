      ...
      <div className="max-w-6xl mx-auto flex flex-wrap items-center gap-3">
          ...
          {STATUS_OPTIONS.map(opt => {
            ...
            return (
              <button
                ...
                style={{
                  background:  active ? 'rgba(201,162,39,0.85)'      : 'rgba(42,30,16,0.65)',
                  color:        active ? '#FDF6E9'                    : '#9A8268',
                  border:       active ? '1px solid rgba(201,162,39,0.6)' : '1px solid rgba(255,255,255,0.07)',
                  boxShadow:    active ? '0 2px 14px rgba(201,162,39,0.25)' : 'none',
                }}
              >
                {opt.label}
              </button>
        ...
        {total !== undefined && (
          <span className="text-xs ml-auto flex-shrink-0" style={{ color: 'rgba(154,130,104,0.6)' }}>
            <span className="font-bold" style={{ color: '#E8C766' }}>{total}</span>
