...
export default function AdminLogin() {
  ...
  return (
    <div className="min-h-screen bg-bark-900 flex items-center justify-center px-4"
      style={{ background: 'radial-gradient(ellipse 100% 70% at 50% 100%, rgba(201,164,78,0.07) 0%, #0F0A04 60%)' }}>

      {/* Ambient glow */}
      <div className="fixed inset-0 pointer-events-none" style={{
        background: 'radial-gradient(ellipse 60% 40% at 50% 0%, rgba(201,164,78,0.06), transparent)',
      }} />
        ...
        <div className="rounded-2xl p-8"
          ...
          <div className="text-center mb-8">
            <div className="w-14 h-14 rounded-2xl flex items-center justify-center text-white font-display text-2xl mx-auto mb-4"
              style={{
                ...
                boxShadow: '0 6px 28px rgba(201,164,78,0.45)',
              }}>
              EE
            </div>
          ...
          <form onSubmit={handleLogin} className="space-y-4">
            ...
            <button
              type="submit"
              disabled={loading}
              className="cta-terra w-full py-3.5 rounded-xl text-bark-900 font-bold text-sm tracking-wide flex items-center justify-center gap-2 disabled:opacity-50 disabled:cursor-not-allowed disabled:transform-none mt-2"
