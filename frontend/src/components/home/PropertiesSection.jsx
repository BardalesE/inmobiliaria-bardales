          ...
          >
            {[
              ...
              <button
                ...
                style={{
                  background: viewMode === m ? '#C9A44E'                   : 'transparent',
                  color:       viewMode === m ? '#FDF6E9'                   : 'rgba(154,130,104,0.8)',
                  boxShadow:   viewMode === m ? '0 2px 8px rgba(201,164,78,0.3)' : 'none',
                }}
              >
                {icon}{label}
              </button>
        ...
        {loading ? (
          ...
          <div className="text-center py-24">
            <div
              ...
              style={{ background: 'rgba(201,164,78,0.08)', border: '1px solid rgba(201,164,78,0.15)' }}
            >
              <svg width="28" height="28" viewBox="0 0 24 24" fill="none" stroke="rgba(217,188,122,0.6)" strokeWidth="1.5" strokeLinecap="round">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-5">
            {properties.map(p => (
              <div
                ...
                onMouseEnter={e => {
                  e.currentTarget.style.borderColor = 'rgba(201,164,78,0.30)'
                  e.currentTarget.style.transform = 'translateY(-4px)'
                  e.currentTarget.style.boxShadow = '0 16px 52px rgba(0,0,0,0.38), 0 0 0 1px rgba(201,164,78,0.10)'
                }}
                onMouseLeave={e => {
              ...
              >
                ...
                <div className="relative overflow-hidden" style={{ height: 216 }}>
                  ...
                  <div className="absolute top-3 left-3 z-10">
                    <span
                      ...
                      style={{
                        background: p.status === 'AVAILABLE' ? 'rgba(201,164,78,0.92)'
                                  : p.status === 'RESERVED'  ? 'rgba(234,179,8,0.88)'
                                  : 'rgba(113,113,122,0.85)',
                        color: (p.status === 'RESERVED' || p.status === 'AVAILABLE') ? '#1C1308' : '#FDF6E9',
                  ...
                  {p.operation && (
                    <div className="absolute top-3 z-10" style={{ left: p.status ? 90 : 12 }}>
                      <span className="text-[9px] font-bold px-2 py-0.5 rounded-full"
                        style={{
                          background: p.operation === 'RENT' ? 'rgba(99,102,241,0.85)' : 'rgba(201,164,78,0.75)',
                          color: '#FDF6E9',
                  ...
                  <button type="button"
                    ...
                    style={{
                      background: likes[p.id] ? 'rgba(201,164,78,0.88)' : 'rgba(0,0,0,0.48)',
                      backdropFilter: 'blur(4px)',
                  ...
                  <div className="absolute bottom-8 left-3 z-10 opacity-0 group-hover:opacity-100 transition-all duration-300 translate-y-1.5 group-hover:translate-y-0">
                    <Link href={`/properties/${p.id}`}
                      ...
                      style={{ background: 'rgba(201,164,78,0.92)', backdropFilter: 'blur(4px)' }}>
                      Ver ubicación →
                    </Link>
                  </div>
                </div>
                ...
                <div className="p-4">
                  <div className="flex items-center justify-between mb-1.5">
                    <span className="text-[10px] font-bold tracking-[0.12em]" style={{ color: '#D9BC7A' }}>{p.ref}</span>
                  ...
                  <div className="flex items-center justify-between">
                    <div>
                      <p className="font-display text-[1.3rem] tracking-wide leading-none" style={{ color: '#D9BC7A' }}>
                    ...
                    <div className="flex gap-1.5">
                      <a
                        ...
                        style={{ background: 'rgba(201,164,78,0.12)', border: '1px solid rgba(201,164,78,0.22)', color: '#C9A44E' }}
                        onMouseEnter={e => e.currentTarget.style.background = 'rgba(201,164,78,0.22)'}
                        onMouseLeave={e => e.currentTarget.style.background = 'rgba(201,164,78,0.12)'}
                      >
                        WA
                      </a>
                      <Link
                        ...
                        onMouseEnter={e => e.currentTarget.style.boxShadow = '0 4px 16px rgba(201,164,78,0.4)'}
              ...
              >
                {p.images?.[0] ? (
                  ...
                  <div className="w-20 h-20 rounded-xl flex-shrink-0 flex items-center justify-center" style={{ background: 'rgba(42,30,16,0.7)' }}>
                    <svg width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="rgba(201,164,78,0.3)" strokeWidth="1.5" strokeLinecap="round">
                      <path d="M3 9.5L12 3l9 6.5V20a1 1 0 01-1 1H4a1 1 0 01-1-1V9.5z"/>
                    </svg>
                  </div>
                )}
                <div className="flex-1 min-w-0 py-0.5">
                  <p className="text-[10px] font-bold mb-1" style={{ color: '#D9BC7A' }}>{p.ref}</p>
                  ...
                  <div className="flex items-center justify-between mt-2">
                    <span className="font-display text-base tracking-wide" style={{ color: '#D9BC7A' }}>S/ {p.price?.toLocaleString()}</span>
                ...
                <button
                  ...
                  style={{
                    background: likes[p.id] ? 'rgba(201,164,78,0.15)' : 'transparent',
                  }}
                >
                  <svg width="15" height="15" viewBox="0 0 24 24" fill={likes[p.id] ? '#D9BC7A' : 'none'} stroke={likes[p.id] ? '#D9BC7A' : 'rgba(154,130,104,0.5)'} strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
                    <path d="M20.84 4.61a5.5 5.5 0 00-7.78 0L12 5.67l-1.06-1.06a5.5 5.5 0 00-7.78 7.78l1.06 1.06L12 21.23l7.78-7.78 1.06-1.06a5.5 5.5 0 000-7.78z"/>
                  </svg>
                </button>
              </Link>
            ...
            {[...Array(pagination.totalPages)].map((_, i) => {
              ...
              return (
                <button
                  ...
                  style={{
                    background:  active ? '#C9A44E'                       : 'rgba(42,30,16,0.65)',
                    color:        active ? '#FDF6E9'                       : 'rgba(154,130,104,0.7)',
                    border:       active ? '1px solid rgba(201,164,78,0.5)' : '1px solid rgba(255,255,255,0.06)',
                    boxShadow:    active ? '0 4px 16px rgba(201,164,78,0.28)' : 'none',
