...
- 🔶 **Fase 7 en curso** (2026-07-04): BD de producción en Aiven MySQL migrada y seedeada (TLS estricto, CA en `prisma/aiven-ca.pem`); repo alineado (GitHub `main` = `15c65d2`, reemplazó copia obsoleta de abril); **backend desplegado en Render** (`https://eestars-api.onrender.com`) — verificado: sirve datos de Aiven, búsqueda OK, endpoints protegidos devuelven 401. Pendiente: frontend en Vercel + `FRONTEND_URL` en Render + smoke de producción + preview de WhatsApp.
- ⬜ Fase 8 pendiente.
