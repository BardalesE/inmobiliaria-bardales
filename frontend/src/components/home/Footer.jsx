          ...
          <div>
            <div className="flex items-center gap-2.5 mb-4">
              <div
                ...
                style={{ background: 'linear-gradient(135deg,#C9A44E,#D9BC7A)', boxShadow: '0 2px 12px rgba(201,164,78,0.3)' }}
              >
                EE
              </div>
