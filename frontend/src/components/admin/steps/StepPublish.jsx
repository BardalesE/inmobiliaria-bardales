    ...
    <div className="space-y-6">
      ...
      <div className="flex items-center justify-between p-4 bg-bark-700/70 border border-white/8 rounded-2xl hover:border-white/12 transition-colors">
        ...
        <button type="button"
          ...
          className={`relative w-12 h-6 rounded-full transition-all flex-shrink-0 ${featured ? 'bg-terra shadow-[0_0_10px_rgba(196,98,45,0.35)]' : 'bg-bark-600 border border-white/12'}`}>
      ...
      <div>
        ...
        <textarea {...register('notes')} rows={3}
          ...
          className="w-full px-3.5 py-3 bg-bark-700 border border-white/8 rounded-xl text-sm text-sand placeholder-sand-muted/30 focus:outline-none focus:border-terra/60 focus:shadow-[0_0_0_3px_rgba(196,98,45,0.09)] resize-none transition-all leading-relaxed" />
      </div>
