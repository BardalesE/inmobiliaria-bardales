...
/* Parte interactiva del catálogo: recibe los datos iniciales renderizados en
   servidor y re-consulta en cliente solo cuando el usuario filtra. */
export default function PropertiesCatalogClient({ initialProperties, initialPagination }) {
